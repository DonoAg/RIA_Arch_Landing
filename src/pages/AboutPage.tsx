...
const founders: Founder[] = [
  ...
  },
  {
    ...
    bio: [
      'Stephen Donovan has over 10 years of experience developing technology in financial services. He was a product manager for Fidelity Wealthscape(sm), focused on improving the operational experience for RIAs and Independent Broker Dealers. He then moved to an internal Fidelity team focused on utilizing emerging technologies to automate internal operational workflows.',
